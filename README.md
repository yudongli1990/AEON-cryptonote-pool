...
```bash
git clone https://github.com/shinesli/AEON-cryptonote-pool.git pool
cd pool
npm update
```
...
Donations
---------
* AEON (to smooth):'WmsSWgtT1JPg5e3cK41hKXSHVpKW7e47bjgiKmWZkYrhSS5LhRemNyqayaSBtAQ6517eo5PtH9wxHVmM78JDZSUu2W8PqRiNs'
